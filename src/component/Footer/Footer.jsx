...
const Footer = () => {
    return (
        <div>
        <footer className="footer mt-8 p-10 shadow-md bg-green-100 rounded-t-md text-base-content">
  <nav>
  ...
  <nav>
    <h6 className="footer-title text-lg text-cyan-900">Company</h6> 
    ...
    <a className="link link-hover font-medium text-gray-600">Jobs</a>
    <a className="link link-hover font-medium text-gray-600">Press kit</a>
  </nav> 
  <nav>
    <h6 className="footer-title text-lg text-cyan-900">Legal</h6> 
    <a className="link link-hover font-medium text-gray-600">Terms of use</a>
...
<footer className="footer px-10 mb-1 py-4  bg-cyan-100 rounded-b-md text-black border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p className="font-semibold text-base"> ExploreEpic Ltd. <br/>Copyright © 2024 - All right reserved by ExploreEpic Ltd</p>
  </aside> 
